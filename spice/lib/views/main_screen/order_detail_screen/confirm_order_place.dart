...
class ConfirmOrdersPlace extends StatefulWidget {
  const ConfirmOrdersPlace({super.key});

  @override
  State<ConfirmOrdersPlace> createState() => _ConfirmOrdersPlaceState();
}

class _ConfirmOrdersPlaceState extends State<ConfirmOrdersPlace> {
 ...
 final friesSnapshot = await FirebaseFirestore.instance
  ...
  Future<void> confirmSelectedOrders() async {
    try {
      final selectedItems = cartItems.where((item) => item.isSelected).toList();
      if (selectedItems.isEmpty) {
        Get.snackbar("Error", "No items selected to booked.",
            backgroundColor: AppColor().primaryColor);
        return;
      }
      ...
      Get.snackbar("Success", "Selected items have been booked.",
          backgroundColor: AppColor().primaryColor);

          
    } catch (e) {
      print(e);
      Get.snackbar("Error", "Failed to booked selected items.",
          backgroundColor: AppColor().primaryColor);
    }
  }
